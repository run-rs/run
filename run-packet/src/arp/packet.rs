...
mod test_arppkt {
  ...
  static FRAME_BYTES: [u8; 60] = [
    0xc4, 0x02, 0x32, 0x6b, 0x00, 0x00, 0xc4, 0x01, 0x32, 0x58, 0x00, 0x00,
    0x08, 0x06, 0x00, 0x01, 0x08, 0x00, 0x06, 0x04, 0x00, 0x01, 0xc4, 0x01,
    0x32, 0x58, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x01, 0xc4, 0x02, 0x32, 0x6b,
  ...
  fn test_safe_construct() {
    ...
    let mut ethpkt =
      EtherPacket::prepend_header(arppkt.release(), &ETHER_HEADER_TEMPLATE);
