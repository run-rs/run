...
impl<'a> Ipv6<'a> {
  ...
  pub fn version(&self) -> u8 {
    let v: u32 =
      (self.header.version_to_flow_label & u32be::from(0xf000_0000)).into();
    (v >> 28) as u8
  }
  ...
  pub fn dscp(&self) -> u8 {
    let v: u32 =
      (self.header.version_to_flow_label & u32be::from(0x0fc0_0000)).into();
    (v >> 22) as u8
  }
  ...
  pub fn ecn(&self) -> u8 {
    let v: u32 =
      (self.header.version_to_flow_label & u32be::from(0x0030_0000)).into();
    (v >> 20) as u8
  }
  ...
  pub fn traffic_class(&self) -> u8 {
    let v: u32 =
      (self.header.version_to_flow_label & u32be::from(0x0ff0_0000)).into();
    (v >> 20) as u8
  }
