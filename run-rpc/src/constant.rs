...
use crate::msgbuffer::RpcHeader;

pub const K_MAX_HOSTNAME_LEN: usize = 128;
pub const K_MAX_ROUTING_INFO_SIZE: usize =
  ETHER_HEADER_LEN + IPV4_HEADER_LEN + UDP_HEADER_LEN;
...
pub const MAX_MSG_SIZE: usize = MAX_CLASS_SIZE
  - ((MAX_CLASS_SIZE / TTR_MAX_DATA_PER_PKT)
    * std::mem::size_of::<RpcHeader>());

/// HugeAlloc
pub const MAX_CLASS_SIZE: usize = 16 * 1024 * 1024;

/// TTr
pub const TTR_MAX_DATA_PER_PKT: usize = 2000;
