...
impl common::stack::tcp::PacketProcesser for SmolTcpPacketProcesser {
  fn build(
    ...
    let total_header_overhead =
      header_len + common::ETHER_HEADER_LEN + common::IPV4_HEADER_LEN;
    ...
    ipv4_pkt.set_total_len(
      (common::IPV4_HEADER_LEN + header_len + payload_len) as u16,
    );
    ...
    tcp_pkt.fill_checksum(
      &Ipv4Address(router_info.src_ipv4.0).into(),
  ...
  fn parse(
    ...
    tcprepr.seq_number =
      common::stack::tcp::TcpSeqNumber(tcp_pkt.seq_number().0);
